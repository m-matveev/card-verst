...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // отпрвака формы по нажатию кнопки
    ...
    Array.prototype.forEach.call(get('input'), function (element) {
        ...
        element.addEventListener("focus", function (e) {
            e.target.parentElement.parentElement.parentElement.classList.remove('error');
    ...
    /**
     * Обработчик отправки формы, валидация и отправка формы
     */
